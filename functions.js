...
function print_text(a){
  ...
  /* TODO: 2. Napisz funkcję, która przyjmuje dwa parametry: firstName oraz lastName a następnie:
      ...
      let greeting = function(firstName, lastName){
          return console.log(`Hello my dear ${firstName} ${lastName}!`)
      }
  ...
  let greetingInterval = setInterval(function(){ console.log("Hello") }, 1000);
  setTimeout(function(){clearInterval(greetingInterval)}, 5000) 